...
int main() {
   ...
   numberOutput.open("numbers2.txt"); //step 2 - what file?

    //write 1 - 100 to the file
   for (int value = 1; value <= 100; value++){

        //remember user output: cout<<value<<endl;
        numberOutput<<value<<" "; //output to the file (step 3) with a space
        if (value % 5 == 0){ // separates by 5 numbers and then shifts to newline
            numberOutput<<endl; 
        }
